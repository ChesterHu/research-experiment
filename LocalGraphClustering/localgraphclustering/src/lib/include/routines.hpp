...
public:
    ...
    vtype proxl1PRrand(vtype num_nodes, vtype* seed, vtype num_seeds, double epsilon, double alpha, 
                        double rho, double* q, double* y, double* d, double* ds, double* dsinv, double* grad, 
                        vtype maxiter);
    // function in proxl1PRrand.cpp
    vtype proxl1PRaccel_rand(vtype num_nodes, vtype* seed, vtype num_seeds, double epsilon, double alpha, 
                        double rho, double* q, double* y, double* d, double* ds, double* dsinv, double* grad, 
                        vtype maxiter);
    // functions in proxl1PRrand.cpp
