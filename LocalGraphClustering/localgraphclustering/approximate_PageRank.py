...
def approximate_PageRank(G,
    ...
    if method == "acl":
    ...
    elif method == "l1reg" or method == "l1reg-rand" or method == "l1reg-rand-accel":
        ...
        if method == "l1reg":
            algo = proxl1PRaccel_cpp
        elif "accel" in method:
            algo = proxl1PRaccel_rand_cpp
        else:
            algo = proxl1PRrand_cpp
        if cpp:
            if ys == None:
